...
export function DayNavigator({ dateKey, onChange, minDateKey, className }: DayNavigatorProps) {
  ...
  return (
    <div
      className={cn(
        "mb-4 flex items-center justify-between gap-2 rounded-(--radius-button) border border-border bg-card px-2 py-2",
        className,
      )}
    >
      <button
        ...
        className="flex h-10 w-10 items-center justify-center rounded-full text-muted-foreground transition-colors hover:bg-primary-soft hover:text-primary disabled:opacity-30"
